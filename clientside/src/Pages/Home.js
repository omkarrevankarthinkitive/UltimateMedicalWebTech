...
function Home() {
  return (
    <div className={module.homeContainer} >
        ...
        <Box sx={{padding:"30px",alignItems:"center", flex: "50%" }}>
          ...
          <Box sx={{display:"flex",justifyContent:"flex-start",alignItems:"center",justifyContent:"space-between"}}>
            ...
            <Button  variant='outlined'sx={{border:"2px solid black",borderRadius:"30px",fontWeight:"bold",float: "right",fontSize:"2.5rem",color:"#08090B"}} ><Link to="/api/login" className={module.loginButton} >Login</Link></Button>
          </Box>
          ...
          <Typography sx={{fontSize:"4rem",fontWeight:"Bold",marginTop:"50px",color:"#454949"}}>DOCTOR MANAGEMENT<span className={module.appOrg}> APP</span> FOR YOUR ORGANISATION <span className={module.appOrg}  ></span></Typography>


          <Box sx={{display:"flex",justifyContent:"flex-start",alignItems:"center",justifyContent:"space-between",marginTop:"140px"}}>
            <Typography variant='p' sx={{fontSize:"16px",fontWeight:"bold",color:"#454949"}}>No more pen and papers to list down appointment</Typography>
        ...
        <Box sx={{ flex: "50%",justifyContent:"center",alignItems:"center",display:"flex"}}>
          <img src={homeImage} alt="This is an home Image" className={module.imgHeight}/>
        </Box>
